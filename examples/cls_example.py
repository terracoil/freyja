...
class DataProcessor:
  ...
  class FileOperations:
    ...
    def __init__(self, main, work_dir: str = "./data", backup: bool = True):
      """Initialize file operations with working directory settings.

      :param main: Main DataProcessor instance with global configuration
    ...
    def process_single(self, input_file: Path,
      ...
      print(f"Global config: {self.main.config_file}")
      print(f"Working directory: {self.work_dir}")
      print(f"Mode: {mode.value}")
      print(f"Backup enabled: {self.backup}")

      if self.main.verbose:
        print(f"📝 Verbose: Using global settings from {self.main.config_file}")
        print(f"📝 Verbose: Main instance processed count: {self.main.processed_count}")
    ...
    def batch_process(self, pattern: str, max_files: int = 100,
      ...
      if self.main.verbose:
        print(f"📝 Verbose: Batch processing using global config from {self.main.config_file}")
  ...
  class ExportOperations:
    ...
    def __init__(self, main, output_dir: str = "./exports"):
  ...
  class Statistics:
    ...
    def __init__(self, main, include_history: bool = False):
