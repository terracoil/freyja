#!/usr/bin/env python
"""Multi-class FreyjaCLI example demonstrating enhanced freyja functionality.

This example shows how to create a FreyjaCLI from multiple classes, with proper
...
def demonstrate_multi_class_usage():
  """Demonstrate various multi-class FreyjaCLI usage patterns."""
  print("🎯 MULTI-CLASS FreyjaCLI DEMONSTRATION")
  print("=" * 50)

  # Example 1: Basic multi-class FreyjaCLI
  print("\n1️⃣ Basic Multi-Class FreyjaCLI:")
  try:
    cli_basic = FreyjaCLI([DataProcessor, FileManager, ReportGenerator])
    print(f"✅ Created FreyjaCLI with {len(cli_basic.target_classes)} classes")
  ...
  print("\n2️⃣ Multi-Class FreyjaCLI with System Integration:")
  try:
    cli_with_system = FreyjaCLI([System, DataProcessor, FileManager])
    print(f"✅ Created FreyjaCLI with System + {len(cli_with_system.target_classes) - 1} other classes")
  ...
  try:
    cli_single = FreyjaCLI([DataProcessor])
...
if __name__ == '__main__':
  ...
  # Create multi-class FreyjaCLI with all utilities
