  ...
  def sample_positional_info(self):
    ...
    return {
      'process': PositionalInfo(
        param_name='input_file', param_type=str, is_required=True, help_text='Input file to process'
      ),
...
class TestPositionalUsageGeneration:
  ...
  def handler_with_required(self):
    ...
    return PositionalHandler({'process': PositionalInfo('input_file', str, True, 'Input file')})

  @pytest.fixture
  def handler_with_optional(self):
    """Create handler with optional positional."""
    return PositionalHandler({'process': PositionalInfo('input_file', str, False, 'Input file')})
...
class TestPositionalExtraction:
  ...
  def test_extract_and_convert_no_positional(self):
    ...
    modified_args, conversion_made = handler.extract_and_convert_positional(args, command_path)
  ...
  def test_extract_and_convert_invalid_type(self):
    ...
    handler = PositionalHandler({'process': PositionalInfo('count', int, True, 'Count parameter')})
...
class TestPositionalDiscovery:
  ...
  def test_discover_from_function_with_required(self):
    ...
    assert pos_info.param_type is str
  ...
  def test_discover_from_function_with_type_annotation(self):
    ...
    assert pos_info.param_type is int
  ...
  def test_discover_from_function_no_annotation(self):
    ...
    assert pos_info.param_type is str  # Defaults to str
