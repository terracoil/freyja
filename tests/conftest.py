...
def function_without_docstring():
  """Test function without parameter docstrings."""
...
def edge_case_methods_class():
  ...
  class EdgeCaseClass:
    ...
    def method_single_required(self, required: str) -> str:
      """Test method with only one required parameter (becomes positional)."""
      return required

    def method_multiple_required(self, first: str, second: int, third: bool) -> str:
      """Test method with multiple required parameters."""
    ...
    def method_with_union_types(self, value: str | int = 'default') -> str:
      """Test method with union type annotation."""
      return str(value)
