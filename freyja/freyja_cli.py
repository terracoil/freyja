"""FreyjaCLI entry point — orchestrates discovery, parsing, and execution."""
...
class FreyjaCLI:
  ...
  def __init__(
    ...
    self.execution_coordinator = ExecutionCoordinator(executors, self.output_capture_config)
