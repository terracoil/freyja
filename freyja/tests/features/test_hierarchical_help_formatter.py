...
class TestHierarchicalHelpFormatter:
    ...
    def setup_method(self):
        ...
        self.parser = argparse.ArgumentParser(
            prog="test_cli", description="Test FreyjaCLI for formatter testing"
        )
...
class TestHierarchicalFormatterWithCommandGroups:
    ...
    def test_format_group_with_command_group_description(self):
        ...
        self.formatter._format_command_with_args_global_command = Mock(
            return_value=["  cmd_group: description"]
        )
...
class TestHierarchicalFormatterEdgeCases:
    ...
    def test_analyze_arguments_with_complex_actions(self):
        ...
        parser.add_argument(
            "--count", type=int, action="append", help="Repeatable integer argument"
        )
        parser.add_argument(
            "--store-const", action="store_const", const="value", help="Store constant"
        )
