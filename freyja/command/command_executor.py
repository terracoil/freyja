...
class CommandExecutor:
  ...
  def _execute_inner_class_command(self, parsed) -> Any:
    ...
    inner_instance = self._create_inner_instance(
      inner_class_obj, parsed._command_path, parsed, parent
    )
  ...
  def execute_command(self, parsed) -> Any:
    """Dispatch a command with spinner and output capture."""
