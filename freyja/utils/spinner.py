...
from ..theme.defaults import get_default_theme
    ...
    with self._lock:
      ...
      if self.verbose:
        ...
        if self.color_formatter and hasattr(self.color_formatter, 'apply_style'):
          try:
            styled_line = self.color_formatter.apply_style(
              self.status_line, get_default_theme().command_output
            )
            print(styled_line)
          except Exception:
        ...
        if self.color_formatter and hasattr(self.color_formatter, 'apply_style'):
          try:
            styled_status = self.color_formatter.apply_style(
              final_status, get_default_theme().command_output
            )
            print(styled_status)
          except Exception:
            print(final_status)
